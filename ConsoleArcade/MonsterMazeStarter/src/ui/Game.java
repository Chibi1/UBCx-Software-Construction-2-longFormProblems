...
//        int monsterRange = current.getChoiceRange();
//        if (id < monsterRange) {
//            Monster m = current.getChoice(id);
//            m.printOutcome();
//            roundOver = true;
//            return;
//        }
//
//        id -= monsterRange;
//        int treasureRange = current.getChoiceRange();
//
//        if (id < treasureRange) {
//            Treasure t = current.getChoice(id);
//            t.printOutcome();
//            roundOver = true;
//            return;
//        }
//
//        id -= treasureRange;
//        int roomRange = current.getChoiceRange();
//
//        if (id < roomRange) {
//            current = current.getChoice(id);
//        } else {
//            System.out.println(INVALID_CHOICE);
//        }
//    }
